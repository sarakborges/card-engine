...
using CardMatch = CardEngine.Core.Match.Match;
using Xunit;
...
public sealed class PlatformTests
{
    ...
    public void Same_seed_produces_same_card_instances_in_opening_hands()
    {
        ...
        var first = CardMatch.Create(content, setup, 42);
        var second = CardMatch.Create(content, setup, 42);
    ...
    public void Playing_board_card_moves_the_specific_instance_to_board()
    {
        ...
        var match = CardMatch.Create(content, setup, 7);
